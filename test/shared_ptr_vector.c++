...
auto main() -> int {
    {
        muc::pmr::shared_ptr_vector<std::pmr::string> v{"hello", "world", "!"};
        print_vector(v);
    }
    std::cout << '\n';
    {
        // muc::pmr::shared_ptr_vector<int> v(6, 6);
        muc::pmr::shared_ptr_vector<float> v(6, 6.);
        print_vector(v);
    }
    std::cout << '\n';
    {
    ...
    std::cout << '\n';
    {
        muc::pmr::shared_ptr_vector<double> v{1, 2, 3, 4, 5};
